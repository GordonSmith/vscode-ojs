...
export class Commands {
    ...
    private constructor(ctx: vscode.ExtensionContext) {
        ...
        ctx.subscriptions.push(vscode.commands.registerCommand("ojs.cell.name", async (cell: vscode.NotebookCell) => {
        ...
        ctx.subscriptions.push(vscode.commands.registerCommand("ojs.cell.db", async (cell: vscode.NotebookCell) => {
            const node = serializer.node(cell);
            const data = {
                ...node?.data
            };
